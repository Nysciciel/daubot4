...
labot_path = root_path / "sniffer"

if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Protocol builder that creates protocol.pk from the decompiled sources"
    )
    parser.add_argument("--sources-path", type=Path, default=root_path / "misc" / "sources")
    parser.add_argument("--labot-path", type=Path, default=labot_path)
