package com.ankamagames.dofus.network
{
   ...
   import com.ankamagames.dofus.network.messages.game.context.roleplay.quest.ViewQuestListMessage;
   ...
   public class MessageReceiver implements RawDataParser
   {
      ...
      {
         _messagesTypes[7104] = NetworkDataContainerMessage;
         _messagesTypes[9546] = ProtocolRequired;
         _messagesTypes[2553] = LoginQueueStatusMessage;
         _messagesTypes[8974] = QueueStatusMessage;
         _messagesTypes[5874] = ConsoleMessage;
         _messagesTypes[6479] = ConsoleCommandsListMessage;
         _messagesTypes[1030] = HelloConnectMessage;
         _messagesTypes[5417] = CredentialsAcknowledgementMessage;
         _messagesTypes[4304] = NicknameRegistrationMessage;
         _messagesTypes[483] = AccountLinkRequiredMessage;
         _messagesTypes[2958] = NicknameRefusedMessage;
         _messagesTypes[2182] = NicknameAcceptedMessage;
         _messagesTypes[7272] = IdentificationSuccessMessage;
         _messagesTypes[3029] = IdentificationSuccessWithLoginTokenMessage;
         _messagesTypes[5778] = IdentificationFailedMessage;
         _messagesTypes[9046] = IdentificationFailedBannedMessage;
         _messagesTypes[8989] = IdentificationFailedForBadVersionMessage;
         _messagesTypes[4096] = ServersListMessage;
         _messagesTypes[6615] = ServerStatusUpdateMessage;
         _messagesTypes[1568] = SelectedServerDataMessage;
         _messagesTypes[900] = SelectedServerDataExtendedMessage;
         _messagesTypes[506] = SelectedServerRefusedMessage;
         _messagesTypes[6800] = AcquaintanceSearchErrorMessage;
         _messagesTypes[6511] = AcquaintanceServerListMessage;
         _messagesTypes[1829] = MigratedServerListMessage;
         _messagesTypes[5556] = HelloGameMessage;
         _messagesTypes[8662] = AuthenticationTicketAcceptedMessage;
         _messagesTypes[3932] = AuthenticationTicketRefusedMessage;
         _messagesTypes[27] = AlreadyConnectedMessage;
         _messagesTypes[9927] = AccountLoggingKickedMessage;
         _messagesTypes[6122] = ReloginTokenStatusMessage;
         _messagesTypes[7281] = ServerSettingsMessage;
         _messagesTypes[20] = ServerSessionConstantsMessage;
         _messagesTypes[4257] = ServerOptionalFeaturesMessage;
         _messagesTypes[7617] = AccountCapabilitiesMessage;
         _messagesTypes[2797] = TrustStatusMessage;
         _messagesTypes[1933] = AccountInformationsUpdateMessage;
         _messagesTypes[7250] = CheckFileRequestMessage;
         _messagesTypes[124] = RawDataMessage;
         _messagesTypes[9717] = StartupActionsListMessage;
         _messagesTypes[2141] = StartupActionAddMessage;
         _messagesTypes[7629] = StartupActionFinishedMessage;
         _messagesTypes[9745] = CharacterCanBeCreatedResultMessage;
         _messagesTypes[9184] = CharacterCreationResultMessage;
         _messagesTypes[4184] = CharacterDeletionErrorMessage;
         _messagesTypes[4878] = CharacterNameSuggestionSuccessMessage;
         _messagesTypes[534] = CharacterNameSuggestionFailureMessage;
         _messagesTypes[6379] = BasicCharactersListMessage;
         _messagesTypes[7692] = CharactersListMessage;
         _messagesTypes[2685] = CharactersListWithRemodelingMessage;
         _messagesTypes[9886] = CharactersListErrorMessage;
         _messagesTypes[7662] = CharacterSelectedSuccessMessage;
         _messagesTypes[621] = CharacterSelectedForceMessage;
         _messagesTypes[2771] = CharacterSelectedErrorMessage;
         _messagesTypes[1148] = PopupWarningMessage;
         _messagesTypes[5022] = BasicDateMessage;
         _messagesTypes[4907] = BasicTimeMessage;
         _messagesTypes[1654] = AlmanachCalendarDateMessage;
         _messagesTypes[7386] = BasicNoOperationMessage;
         _messagesTypes[3130] = BasicAckMessage;
         _messagesTypes[1803] = SystemMessageDisplayMessage;
         _messagesTypes[8845] = TextInformationMessage;
         _messagesTypes[5599] = OnConnectionEventMessage;
         _messagesTypes[4678] = SetCharacterRestrictionsMessage;
         _messagesTypes[622] = ServerExperienceModificatorMessage;
         _messagesTypes[6008] = CharacterCapabilitiesMessage;
         _messagesTypes[5554] = CharacterLoadingCompleteMessage;
         _messagesTypes[7145] = GameContextCreateMessage;
         _messagesTypes[8144] = GameContextCreateErrorMessage;
         _messagesTypes[3855] = GameContextDestroyMessage;
         _messagesTypes[6263] = GameContextRemoveElementMessage;
         _messagesTypes[9535] = GameContextRemoveMultipleElementsMessage;
         _messagesTypes[7176] = GameContextRemoveElementWithEventMessage;
         _messagesTypes[3428] = GameContextRemoveMultipleElementsWithEventsMessage;
         _messagesTypes[2199] = GameContextMoveElementMessage;
         _messagesTypes[190] = GameContextMoveMultipleElementsMessage;
         _messagesTypes[6261] = GameContextRefreshEntityLookMessage;
         _messagesTypes[9231] = GameMapNoMovementMessage;
         _messagesTypes[4500] = GameMapMovementMessage;
         _messagesTypes[1982] = GameCautiousMapMovementMessage;
         _messagesTypes[2457] = GameMapChangeOrientationMessage;
         _messagesTypes[9267] = GameMapChangeOrientationsMessage;
         _messagesTypes[5064] = GameEntityDispositionMessage;
         _messagesTypes[4495] = GameEntitiesDispositionMessage;
         _messagesTypes[758] = GameEntityDispositionErrorMessage;
         _messagesTypes[5083] = GameRefreshMonsterBoostsMessage;
         _messagesTypes[266] = PlayerStatusUpdateErrorMessage;
         _messagesTypes[626] = PlayerStatusUpdateMessage;
         _messagesTypes[5025] = BasicWhoIsMessage;
         _messagesTypes[2995] = BasicWhoIsNoMatchMessage;
         _messagesTypes[5847] = NumericWhoIsMessage;
         _messagesTypes[8578] = BasicPongMessage;
         _messagesTypes[7797] = BasicLatencyStatsRequestMessage;
         _messagesTypes[3495] = SequenceNumberRequestMessage;
         _messagesTypes[144] = CurrentServerStatusUpdateMessage;
         _messagesTypes[1487] = CinematicMessage;
         _messagesTypes[3013] = DumpedEntityStatsMessage;
         _messagesTypes[505] = DebugHighlightCellsMessage;
         _messagesTypes[5964] = DebugClearHighlightCellsMessage;
         _messagesTypes[9388] = DebugInClientMessage;
         _messagesTypes[3068] = ClientYouAreDrunkMessage;
         _messagesTypes[3417] = DisplayNumericalValuePaddockMessage;
         _messagesTypes[3437] = CurrentMapMessage;
         _messagesTypes[5592] = CurrentMapInstanceMessage;
         _messagesTypes[6365] = TeleportOnSameMapMessage;
         _messagesTypes[1367] = MapFightCountMessage;
         _messagesTypes[7526] = MapRunningFightListMessage;
         _messagesTypes[7867] = MapRunningFightDetailsMessage;
         _messagesTypes[9242] = MapRunningFightDetailsExtendedMessage;
         _messagesTypes[3135] = MapObstacleUpdateMessage;
         _messagesTypes[7028] = MapComplementaryInformationsDataMessage;
         _messagesTypes[3195] = MapComplementaryInformationsDataInHouseMessage;
         _messagesTypes[6445] = MapComplementaryInformationsWithCoordsMessage;
         _messagesTypes[3807] = MapRewardRateMessage;
         _messagesTypes[3363] = BreachEnterMessage;
         _messagesTypes[9007] = BreachTeleportResponseMessage;
         _messagesTypes[8531] = BreachRoomLockedMessage;
         _messagesTypes[485] = BreachRoomUnlockResultMessage;
         _messagesTypes[702] = BreachExitResponseMessage;
         _messagesTypes[125] = MapComplementaryInformationsBreachMessage;
         _messagesTypes[1630] = BreachGameFightEndMessage;
         _messagesTypes[1170] = AnomalyStateMessage;
         _messagesTypes[5651] = MapComplementaryInformationsAnomalyMessage;
         _messagesTypes[7470] = MapFightStartPositionsUpdateMessage;
         _messagesTypes[2285] = GameRolePlayShowActorMessage;
         _messagesTypes[1154] = GameRolePlayShowMultipleActorsMessage;
         _messagesTypes[1688] = GameRolePlayShowActorWithEventMessage;
         _messagesTypes[8054] = CharacterStatsListMessage;
         _messagesTypes[6640] = FighterStatsListMessage;
         _messagesTypes[6108] = UpdateSpellModifierMessage;
         _messagesTypes[3887] = CharacterLevelUpMessage;
         _messagesTypes[8597] = CharacterExperienceGainMessage;
         _messagesTypes[8391] = CharacterLevelUpInformationMessage;
         _messagesTypes[9545] = UpdateLifePointsMessage;
         _messagesTypes[8582] = LifePointsRegenBeginMessage;
         _messagesTypes[2608] = LifePointsRegenEndMessage;
         _messagesTypes[7932] = GameRolePlayPlayerLifeStatusMessage;
         _messagesTypes[341] = GameRolePlayGameOverMessage;
         _messagesTypes[3985] = GameRolePlayFightRequestCanceledMessage;
         _messagesTypes[6230] = GameRolePlayAggressionMessage;
         _messagesTypes[6705] = GameRolePlayPlayerFightFriendlyRequestedMessage;
         _messagesTypes[831] = GameRolePlayPlayerFightFriendlyAnsweredMessage;
         _messagesTypes[1923] = GameRolePlayArenaRegistrationStatusMessage;
         _messagesTypes[6895] = GameRolePlayArenaFightPropositionMessage;
         _messagesTypes[414] = GameRolePlayArenaFighterStatusMessage;
         _messagesTypes[685] = GameRolePlayArenaUpdatePlayerInfosMessage;
         _messagesTypes[8647] = GameRolePlayArenaUpdatePlayerInfosAllQueuesMessage;
         _messagesTypes[1661] = GameRolePlayArenaSwitchToFightServerMessage;
         _messagesTypes[4630] = GameRolePlayArenaSwitchToGameServerMessage;
         _messagesTypes[3563] = GameRolePlayArenaInvitationCandidatesAnswerMessage;
         _messagesTypes[9130] = GameRolePlayArenaLeagueRewardsMessage;
         _messagesTypes[3690] = GameRolePlayMonsterAngryAtPlayerMessage;
         _messagesTypes[1147] = GameRolePlayMonsterNotAngryAtPlayerMessage;
         _messagesTypes[913] = GameRolePlayShowChallengeMessage;
         _messagesTypes[7713] = GameRolePlayRemoveChallengeMessage;
         _messagesTypes[3460] = GameRolePlaySpellAnimMessage;
         _messagesTypes[6] = GameRolePlayDelayedActionMessage;
         _messagesTypes[7421] = GameRolePlayDelayedObjectUseMessage;
         _messagesTypes[8226] = GameRolePlayDelayedActionFinishedMessage;
         _messagesTypes[7307] = ShowCellMessage;
         _messagesTypes[3955] = ShowCellSpectatorMessage;
         _messagesTypes[7976] = GameFightStartingMessage;
         _messagesTypes[1625] = GameFightJoinMessage;
         _messagesTypes[5142] = GameFightSpectatorJoinMessage;
         _messagesTypes[8260] = GameFightPlacementPossiblePositionsMessage;
         _messagesTypes[1174] = GameFightPlacementSwapPositionsErrorMessage;
         _messagesTypes[2478] = GameFightPlacementSwapPositionsOfferMessage;
         _messagesTypes[4242] = GameFightPlacementSwapPositionsCancelledMessage;
         _messagesTypes[5945] = GameFightPlacementSwapPositionsMessage;
         _messagesTypes[4364] = GameFightOptionStateUpdateMessage;
         _messagesTypes[6859] = GameFightUpdateTeamMessage;
         _messagesTypes[8042] = GameFightRemoveTeamMemberMessage;
         _messagesTypes[2996] = GameFightHumanReadyStateMessage;
         _messagesTypes[2140] = GameFightLeaveMessage;
         _messagesTypes[9766] = GameFightStartMessage;
         _messagesTypes[9114] = GameFightSpectateMessage;
         _messagesTypes[7575] = GameFightResumeMessage;
         _messagesTypes[2845] = GameFightResumeWithSlavesMessage;
         _messagesTypes[788] = GameFightEndMessage;
         _messagesTypes[1563] = GameFightNewRoundMessage;
         _messagesTypes[3288] = GameFightTurnListMessage;
         _messagesTypes[1672] = GameFightTurnStartMessage;
         _messagesTypes[3548] = GameFightNewWaveMessage;
         _messagesTypes[3485] = GameFightTurnStartPlayingMessage;
         _messagesTypes[373] = GameFightTurnResumeMessage;
         _messagesTypes[6391] = GameFightPauseMessage;
         _messagesTypes[4446] = SlaveSwitchContextMessage;
         _messagesTypes[8844] = SlaveNoLongerControledMessage;
         _messagesTypes[6509] = RefreshCharacterStatsMessage;
         _messagesTypes[5750] = GameFightTurnReadyRequestMessage;
         _messagesTypes[9757] = GameFightSynchronizeMessage;
         _messagesTypes[6535] = GameFightTurnEndMessage;
         _messagesTypes[6252] = GameFightShowFighterMessage;
         _messagesTypes[1835] = GameFightRefreshFighterMessage;
         _messagesTypes[2881] = GameFightShowFighterRandomStaticPoseMessage;
         _messagesTypes[5912] = ArenaFighterLeaveMessage;
         _messagesTypes[2177] = SequenceStartMessage;
         _messagesTypes[5793] = SequenceEndMessage;
         _messagesTypes[8538] = AbstractGameActionMessage;
         _messagesTypes[1456] = GameActionNoopMessage;
         _messagesTypes[8082] = GameActionSpamMessage;
         _messagesTypes[4833] = AbstractGameActionWithAckMessage;
         _messagesTypes[9699] = GameActionFightNoSpellCastMessage;
         _messagesTypes[8120] = AbstractGameActionFightTargetedAbilityMessage;
         _messagesTypes[9132] = GameActionFightSpellCastMessage;
         _messagesTypes[1779] = GameActionFightCloseCombatMessage;
         _messagesTypes[8672] = GameActionUpdateEffectTriggerCountMessage;
         _messagesTypes[8639] = GameActionFightInvisibleDetectedMessage;
         _messagesTypes[926] = GameActionFightPointsVariationMessage;
         _messagesTypes[5099] = GameActionFightTackledMessage;
         _messagesTypes[3456] = GameActionFightDeathMessage;
         _messagesTypes[6338] = GameActionFightKillMessage;
         _messagesTypes[2891] = GameActionFightVanishMessage;
         _messagesTypes[3800] = GameActionFightSpellCooldownVariationMessage;
         _messagesTypes[23] = GameActionFightSpellImmunityMessage;
         _messagesTypes[6278] = GameActionFightLifePointsGainMessage;
         _messagesTypes[5685] = GameActionFightLifePointsLostMessage;
         _messagesTypes[6688] = GameActionFightLifeAndShieldPointsLostMessage;
         _messagesTypes[4163] = GameActionFightDispellableEffectMessage;
         _messagesTypes[4667] = GameActionFightReflectSpellMessage;
         _messagesTypes[2266] = GameActionFightReduceDamagesMessage;
         _messagesTypes[1499] = GameActionFightReflectDamagesMessage;
         _messagesTypes[6416] = GameActionFightDodgePointLossMessage;
         _messagesTypes[4704] = GameActionFightSlideMessage;
         _messagesTypes[7248] = GameActionFightTeleportOnSameMapMessage;
         _messagesTypes[1851] = GameActionFightExchangePositionsMessage;
         _messagesTypes[3834] = GameActionFightDispellMessage;
         _messagesTypes[8035] = GameActionFightDispellEffectMessage;
         _messagesTypes[3642] = GameActionFightDispellSpellMessage;
         _messagesTypes[4973] = GameActionFightModifyEffectsDurationMessage;
         _messagesTypes[8207] = GameActionFightTriggerEffectMessage;
         _messagesTypes[7468] = GameActionFightStealKamaMessage;
         _messagesTypes[9994] = GameActionFightChangeLookMessage;
         _messagesTypes[4346] = GameActionFightInvisibilityMessage;
         _messagesTypes[7600] = GameActionFightSummonMessage;
         _messagesTypes[5219] = GameActionFightMultipleSummonMessage;
         _messagesTypes[3605] = GameActionFightMarkCellsMessage;
         _messagesTypes[9652] = GameActionFightUnmarkCellsMessage;
         _messagesTypes[9566] = GameActionFightTriggerGlyphTrapMessage;
         _messagesTypes[1091] = GameActionFightActivateGlyphTrapMessage;
         _messagesTypes[5691] = GameActionFightCarryCharacterMessage;
         _messagesTypes[4198] = GameActionFightThrowCharacterMessage;
         _messagesTypes[9345] = GameActionFightDropCharacterMessage;
         _messagesTypes[1580] = EmoteListMessage;
         _messagesTypes[6710] = EmoteAddMessage;
         _messagesTypes[4718] = EmoteRemoveMessage;
         _messagesTypes[8273] = EmotePlayAbstractMessage;
         _messagesTypes[8706] = EmotePlayMessage;
         _messagesTypes[2897] = EmotePlayMassiveMessage;
         _messagesTypes[8576] = EmotePlayErrorMessage;
         _messagesTypes[7703] = ChatSmileyMessage;
         _messagesTypes[6353] = ChatCommunityChannelCommunityMessage;
         _messagesTypes[8903] = LocalizedChatSmileyMessage;
         _messagesTypes[1900] = MoodSmileyResultMessage;
         _messagesTypes[8472] = MoodSmileyUpdateMessage;
         _messagesTypes[9998] = ChatSmileyExtraPackListMessage;
         _messagesTypes[7258] = ChatAbstractServerMessage;
         _messagesTypes[5855] = ChatServerMessage;
         _messagesTypes[2714] = ChatAdminServerMessage;
         _messagesTypes[5393] = ChatServerWithObjectMessage;
         _messagesTypes[4685] = ChatServerCopyMessage;
         _messagesTypes[4950] = ChatServerCopyWithObjectMessage;
         _messagesTypes[8458] = ChatErrorMessage;
         _messagesTypes[5294] = EnabledChannelsMessage;
         _messagesTypes[3156] = ChannelEnablingChangeMessage;
         _messagesTypes[8397] = SpellListMessage;
         _messagesTypes[2693] = ForgettableSpellListUpdateMessage;
         _messagesTypes[9772] = ForgettableSpellDeleteMessage;
         _messagesTypes[3440] = ForgettableSpellEquipmentSlotsMessage;
         _messagesTypes[7199] = LeaveDialogMessage;
         _messagesTypes[1952] = PauseDialogMessage;
         _messagesTypes[5333] = InteractiveUseErrorMessage;
         _messagesTypes[9664] = InteractiveUsedMessage;
         _messagesTypes[6869] = InteractiveUseEndedMessage;
         _messagesTypes[6385] = InteractiveMapUpdateMessage;
         _messagesTypes[4814] = StatedMapUpdateMessage;
         _messagesTypes[9844] = InteractiveElementUpdatedMessage;
         _messagesTypes[4006] = StatedElementUpdatedMessage;
         _messagesTypes[6062] = ZaapRespawnUpdatedMessage;
         _messagesTypes[2128] = TeleportDestinationsMessage;
         _messagesTypes[1847] = ZaapDestinationsMessage;
         _messagesTypes[9689] = KnownZaapListMessage;
         _messagesTypes[172] = TeleportBuddiesMessage;
         _messagesTypes[3681] = TeleportBuddiesRequestedMessage;
         _messagesTypes[4964] = TeleportToBuddyOfferMessage;
         _messagesTypes[2978] = TeleportToBuddyCloseMessage;
         _messagesTypes[2077] = SpellVariantActivationMessage;
         _messagesTypes[5570] = StatsUpgradeResultMessage;
         _messagesTypes[1509] = ChallengeTargetsListMessage;
         _messagesTypes[3238] = ChallengeInfoMessage;
         _messagesTypes[8121] = ChallengeTargetUpdateMessage;
         _messagesTypes[2828] = ChallengeResultMessage;
         _messagesTypes[2176] = EntityInformationMessage;
         _messagesTypes[45] = EntitiesInformationMessage;
         _messagesTypes[2333] = IdolSelectErrorMessage;
         _messagesTypes[8102] = IdolSelectedMessage;
         _messagesTypes[3868] = IdolListMessage;
         _messagesTypes[5681] = IdolPartyRefreshMessage;
         _messagesTypes[5868] = IdolPartyLostMessage;
         _messagesTypes[8948] = IdolFightPreparationUpdateMessage;
         _messagesTypes[9654] = AchievementListMessage;
         _messagesTypes[6639] = AchievementDetailsMessage;
         _messagesTypes[8315] = AchievementDetailedListMessage;
         _messagesTypes[1599] = AchievementAlmostFinishedDetailedListMessage;
         _messagesTypes[7456] = AchievementFinishedMessage;
         _messagesTypes[6462] = AchievementFinishedInformationMessage;
         _messagesTypes[2240] = AchievementRewardSuccessMessage;
         _messagesTypes[8701] = AchievementRewardErrorMessage;
         _messagesTypes[5548] = FriendGuildWarnOnAchievementCompleteStateMessage;
         _messagesTypes[8074] = DungeonKeyRingMessage;
         _messagesTypes[91] = DungeonKeyRingUpdateMessage;
         _messagesTypes[8171] = UpdateMapPlayersAgressableStatusMessage;
         _messagesTypes[3063] = UpdateSelfAgressableStatusMessage;
         _messagesTypes[1286] = AlignmentRankUpdateMessage;
         _messagesTypes[1700] = CompassResetMessage;
         _messagesTypes[5070] = CompassUpdateMessage;
         _messagesTypes[1539] = CompassUpdatePartyMemberMessage;
         _messagesTypes[9787] = AtlasPointInformationsMessage;
         _messagesTypes[7293] = CompassUpdatePvpSeekMessage;
         _messagesTypes[2102] = AbstractPartyMessage;
         _messagesTypes[8018] = AbstractPartyEventMessage;
         _messagesTypes[240] = PartyModifiableStatusMessage;
         _messagesTypes[110] = PartyInvitationMessage;
         _messagesTypes[5459] = PartyInvitationDungeonMessage;
         _messagesTypes[9943] = PartyInvitationDetailsMessage;
         _messagesTypes[984] = PartyInvitationDungeonDetailsMessage;
         _messagesTypes[8562] = PartyInvitationCancelledForGuestMessage;
         _messagesTypes[1017] = PartyCancelInvitationNotificationMessage;
         _messagesTypes[7135] = PartyRefuseInvitationNotificationMessage;
         _messagesTypes[1626] = PartyCannotJoinErrorMessage;
         _messagesTypes[1379] = PartyJoinMessage;
         _messagesTypes[4272] = PartyNewGuestMessage;
         _messagesTypes[5094] = PartyUpdateMessage;
         _messagesTypes[7489] = PartyNewMemberMessage;
         _messagesTypes[1032] = PartyUpdateLightMessage;
         _messagesTypes[4825] = PartyEntityUpdateLightMessage;
         _messagesTypes[6103] = PartyMemberRemoveMessage;
         _messagesTypes[9776] = PartyMemberEjectedMessage;
         _messagesTypes[8574] = PartyLeaderUpdateMessage;
         _messagesTypes[2715] = PartyFollowStatusUpdateMessage;
         _messagesTypes[5421] = PartyLocateMembersMessage;
         _messagesTypes[3653] = PartyLeaveMessage;
         _messagesTypes[1519] = PartyKickedByMessage;
         _messagesTypes[811] = PartyRestrictedMessage;
         _messagesTypes[701] = PartyDeletedMessage;
         _messagesTypes[7878] = PartyLoyaltyStatusMessage;
         _messagesTypes[3878] = AbstractPartyMemberInFightMessage;
         _messagesTypes[8272] = PartyMemberInStandardFightMessage;
         _messagesTypes[7397] = PartyMemberInBreachFightMessage;
         _messagesTypes[717] = PartyNameUpdateMessage;
         _messagesTypes[8663] = PartyNameSetErrorMessage;
         _messagesTypes[9154] = DungeonPartyFinderAvailableDungeonsMessage;
         _messagesTypes[4862] = DungeonPartyFinderListenErrorMessage;
         _messagesTypes[7435] = DungeonPartyFinderRoomContentMessage;
         _messagesTypes[2889] = DungeonPartyFinderRoomContentUpdateMessage;
         _messagesTypes[6216] = DungeonPartyFinderRegisterSuccessMessage;
         _messagesTypes[7202] = DungeonPartyFinderRegisterErrorMessage;
         _messagesTypes[3846] = ContactAddFailureMessage;
         _messagesTypes[7078] = SpouseStatusMessage;
         _messagesTypes[5325] = FriendsListMessage;
         _messagesTypes[4437] = AcquaintancesListMessage;
         _messagesTypes[7052] = SpouseInformationsMessage;
         _messagesTypes[4035] = FriendAddFailureMessage;
         _messagesTypes[4917] = AcquaintanceAddedMessage;
         _messagesTypes[2089] = FriendAddedMessage;
         _messagesTypes[4416] = FriendUpdateMessage;
         _messagesTypes[7198] = FriendDeleteResultMessage;
         _messagesTypes[5574] = FriendWarnOnConnectionStateMessage;
         _messagesTypes[1798] = WarnOnPermaDeathStateMessage;
         _messagesTypes[1433] = FriendWarnOnLevelGainStateMessage;
         _messagesTypes[6126] = FriendStatusShareStateMessage;
         _messagesTypes[4183] = IgnoredListMessage;
         _messagesTypes[7724] = IgnoredAddFailureMessage;
         _messagesTypes[8626] = IgnoredAddedMessage;
         _messagesTypes[1421] = IgnoredDeleteResultMessage;
         _messagesTypes[4296] = AllianceCreationStartedMessage;
         _messagesTypes[773] = AllianceModificationStartedMessage;
         _messagesTypes[8366] = AllianceCreationResultMessage;
         _messagesTypes[6014] = AllianceInvitedMessage;
         _messagesTypes[6648] = AllianceInvitationStateRecruterMessage;
         _messagesTypes[6214] = AllianceInvitationStateRecrutedMessage;
         _messagesTypes[9123] = AllianceJoinedMessage;
         _messagesTypes[5695] = AllianceGuildLeavingMessage;
         _messagesTypes[4444] = AllianceLeftMessage;
         _messagesTypes[3816] = AllianceMembershipMessage;
         _messagesTypes[2532] = KohUpdateMessage;
         _messagesTypes[8822] = AreaFightModificatorUpdateMessage;
         _messagesTypes[2042] = ClientUIOpenedMessage;
         _messagesTypes[6653] = ClientUIOpenedByObjectMessage;
         _messagesTypes[3184] = GuildCreationStartedMessage;
         _messagesTypes[8169] = GuildModificationStartedMessage;
         _messagesTypes[4519] = GuildCreationResultMessage;
         _messagesTypes[7256] = GuildInvitedMessage;
         _messagesTypes[1552] = GuildInvitationStateRecruterMessage;
         _messagesTypes[1335] = GuildInvitationStateRecrutedMessage;
         _messagesTypes[8890] = GuildJoinedMessage;
         _messagesTypes[4687] = GuildMemberOnlineStatusMessage;
         _messagesTypes[3011] = GuildInformationsGeneralMessage;
         _messagesTypes[1603] = GuildInformationsMembersMessage;
         _messagesTypes[9019] = GuildInformationsMemberUpdateMessage;
         _messagesTypes[1363] = GuildInformationsPaddocksMessage;
         _messagesTypes[1501] = GuildMemberLeavingMessage;
         _messagesTypes[96] = GuildLeftMessage;
         _messagesTypes[8256] = GuildMembershipMessage;
         _messagesTypes[4362] = GuildLevelUpMessage;
         _messagesTypes[6746] = GuildInfosUpgradeMessage;
         _messagesTypes[843] = GuildHousesInformationMessage;
         _messagesTypes[952] = GuildHouseUpdateInformationMessage;
         _messagesTypes[9595] = GuildHouseRemoveMessage;
         _messagesTypes[6883] = GuildPaddockBoughtMessage;
         _messagesTypes[2520] = GuildPaddockRemovedMessage;
         _messagesTypes[8211] = GuildMemberWarnOnConnectionStateMessage;
         _messagesTypes[1592] = GuildMotdMessage;
         _messagesTypes[4213] = GuildMotdSetErrorMessage;
         _messagesTypes[5925] = GuildBulletinMessage;
         _messagesTypes[8149] = GuildBulletinSetErrorMessage;
         _messagesTypes[3732] = GuildFactsErrorMessage;
         _messagesTypes[7964] = GuildFactsMessage;
         _messagesTypes[8547] = GuildInAllianceFactsMessage;
         _messagesTypes[1681] = AllianceFactsErrorMessage;
         _messagesTypes[3978] = AllianceFactsMessage;
         _messagesTypes[3110] = GuildListMessage;
         _messagesTypes[4534] = GuildVersatileInfoListMessage;
         _messagesTypes[2581] = AllianceListMessage;
         _messagesTypes[6958] = AllianceVersatileInfoListMessage;
         _messagesTypes[1670] = AlliancePartialListMessage;
         _messagesTypes[8455] = AllianceInsiderInfoMessage;
         _messagesTypes[2721] = AllianceMotdMessage;
         _messagesTypes[3284] = AllianceMotdSetErrorMessage;
         _messagesTypes[6273] = AllianceBulletinMessage;
         _messagesTypes[9312] = AllianceBulletinSetErrorMessage;
         _messagesTypes[4295] = TaxCollectorMovementMessage;
         _messagesTypes[5893] = TaxCollectorErrorMessage;
         _messagesTypes[7490] = AbstractTaxCollectorListMessage;
         _messagesTypes[7528] = TaxCollectorListMessage;
         _messagesTypes[523] = TopTaxCollectorListMessage;
         _messagesTypes[7245] = TaxCollectorStateUpdateMessage;
         _messagesTypes[5745] = TaxCollectorMovementAddMessage;
         _messagesTypes[778] = TaxCollectorMovementRemoveMessage;
         _messagesTypes[9866] = TaxCollectorAttackedMessage;
         _messagesTypes[4154] = TaxCollectorAttackedResultMessage;
         _messagesTypes[6219] = GuildFightPlayersHelpersJoinMessage;
         _messagesTypes[1445] = GuildFightPlayersHelpersLeaveMessage;
         _messagesTypes[3648] = GuildFightPlayersEnemiesListMessage;
         _messagesTypes[1291] = GuildFightPlayersEnemyRemoveMessage;
         _messagesTypes[1715] = TaxCollectorMovementsOfflineMessage;
         _messagesTypes[527] = PrismSetSabotagedRefusedMessage;
         _messagesTypes[6333] = PrismFightDefenderAddMessage;
         _messagesTypes[7240] = PrismFightDefenderLeaveMessage;
         _messagesTypes[9673] = PrismFightAttackerAddMessage;
         _messagesTypes[6919] = PrismFightAttackerRemoveMessage;
         _messagesTypes[6207] = PrismsListMessage;
         _messagesTypes[101] = PrismsListUpdateMessage;
         _messagesTypes[1224] = ChallengeFightJoinRefusedMessage;
         _messagesTypes[4982] = PrismInfoCloseMessage;
         _messagesTypes[5320] = PrismsInfoValidMessage;
         _messagesTypes[9746] = PrismFightAddedMessage;
         _messagesTypes[418] = PrismFightRemovedMessage;
         _messagesTypes[7210] = PrismInfoInValidMessage;
         _messagesTypes[8529] = PrismFightStateUpdateMessage;
         _messagesTypes[9214] = PrismSettingsErrorMessage;
         _messagesTypes[6337] = QuestListMessage;
         _messagesTypes[5319] = ViewQuestListMessage;
         _messagesTypes[6417] = QuestStartedMessage;
         _messagesTypes[8020] = QuestValidatedMessage;
         _messagesTypes[6517] = QuestObjectiveValidatedMessage;
         _messagesTypes[8401] = QuestStepValidatedMessage;
         _messagesTypes[4938] = QuestStepStartedMessage;
         _messagesTypes[1124] = QuestStepInfoMessage;
         _messagesTypes[6209] = FollowedQuestsMessage;
         _messagesTypes[6961] = NotificationListMessage;
         _messagesTypes[3065] = NotificationByServerMessage;
         _messagesTypes[6711] = SubscriptionLimitationMessage;
         _messagesTypes[7757] = SubscriptionZoneMessage;
         _messagesTypes[6892] = GuestLimitationMessage;
         _messagesTypes[6388] = GuestModeMessage;
         _messagesTypes[2580] = ListMapNpcsQuestStatusUpdateMessage;
         _messagesTypes[420] = NpcGenericActionFailureMessage;
         _messagesTypes[3236] = PortalDialogCreationMessage;
         _messagesTypes[8206] = NpcDialogCreationMessage;
         _messagesTypes[4062] = NpcDialogQuestionMessage;
         _messagesTypes[5444] = TaxCollectorDialogQuestionBasicMessage;
         _messagesTypes[6454] = TaxCollectorDialogQuestionExtendedMessage;
         _messagesTypes[9640] = AllianceTaxCollectorDialogQuestionExtendedMessage;
         _messagesTypes[8083] = AlliancePrismDialogQuestionMessage;
         _messagesTypes[8783] = EntityTalkMessage;
         _messagesTypes[1546] = JobDescriptionMessage;
         _messagesTypes[5198] = JobLevelUpMessage;
         _messagesTypes[5307] = JobExperienceMultiUpdateMessage;
         _messagesTypes[8784] = JobExperienceUpdateMessage;
         _messagesTypes[4536] = JobExperienceOtherPlayerUpdateMessage;
         _messagesTypes[7444] = JobAllowMultiCraftRequestMessage;
         _messagesTypes[3671] = JobMultiCraftAvailableSkillsMessage;
         _messagesTypes[996] = JobCrafterDirectoryListMessage;
         _messagesTypes[8059] = JobCrafterDirectorySettingsMessage;
         _messagesTypes[2795] = JobBookSubscriptionMessage;
         _messagesTypes[425] = JobCrafterDirectoryRemoveMessage;
         _messagesTypes[4713] = JobCrafterDirectoryAddMessage;
         _messagesTypes[9241] = JobCrafterDirectoryEntryMessage;
         _messagesTypes[9819] = KamasUpdateMessage;
         _messagesTypes[9392] = ObjectGroundAddedMessage;
         _messagesTypes[7865] = ObjectGroundListAddedMessage;
         _messagesTypes[574] = ObjectGroundRemovedMessage;
         _messagesTypes[5709] = ObjectGroundRemovedMultipleMessage;
         _messagesTypes[4723] = InventoryContentMessage;
         _messagesTypes[3036] = WatchInventoryContentMessage;
         _messagesTypes[9017] = ShortcutBarContentMessage;
         _messagesTypes[6536] = ShortcutBarAddErrorMessage;
         _messagesTypes[7694] = ShortcutBarRemoveErrorMessage;
         _messagesTypes[7576] = ShortcutBarSwapErrorMessage;
         _messagesTypes[6320] = ShortcutBarRefreshMessage;
         _messagesTypes[7572] = ShortcutBarRemovedMessage;
         _messagesTypes[2820] = ShortcutBarReplacedMessage;
         _messagesTypes[567] = StorageInventoryContentMessage;
         _messagesTypes[1383] = StorageKamasUpdateMessage;
         _messagesTypes[3827] = StorageObjectUpdateMessage;
         _messagesTypes[2221] = StorageObjectsUpdateMessage;
         _messagesTypes[8680] = StorageObjectRemoveMessage;
         _messagesTypes[2935] = StorageObjectsRemoveMessage;
         _messagesTypes[8665] = SetUpdateMessage;
         _messagesTypes[7128] = InventoryWeightMessage;
         _messagesTypes[3776] = ObjectMovementMessage;
         _messagesTypes[8476] = ObjectAddedMessage;
         _messagesTypes[2979] = ObjectsAddedMessage;
         _messagesTypes[3100] = GoldAddedMessage;
         _messagesTypes[4003] = ObjectErrorMessage;
         _messagesTypes[793] = ObjectDeletedMessage;
         _messagesTypes[610] = ObjectsDeletedMessage;
         _messagesTypes[9204] = ObjectQuantityMessage;
         _messagesTypes[5816] = ObjectsQuantityMessage;
         _messagesTypes[3939] = ObjectModifiedMessage;
         _messagesTypes[9804] = ObjectJobAddedMessage;
         _messagesTypes[6736] = ObtainedItemMessage;
         _messagesTypes[9051] = ObtainedItemWithBonusMessage;
         _messagesTypes[2732] = LivingObjectMessageMessage;
         _messagesTypes[4539] = SymbioticObjectErrorMessage;
         _messagesTypes[3468] = SymbioticObjectAssociatedMessage;
         _messagesTypes[4826] = WrapperObjectErrorMessage;
         _messagesTypes[8396] = WrapperObjectAssociatedMessage;
         _messagesTypes[7339] = MimicryObjectPreviewMessage;
         _messagesTypes[809] = MimicryObjectErrorMessage;
         _messagesTypes[14] = MimicryObjectAssociatedMessage;
         _messagesTypes[3104] = InvalidPresetsMessage;
         _messagesTypes[600] = PresetsMessage;
         _messagesTypes[12] = ItemForPresetUpdateMessage;
         _messagesTypes[3811] = PresetSavedMessage;
         _messagesTypes[918] = PresetSaveErrorMessage;
         _messagesTypes[6559] = PresetDeleteResultMessage;
         _messagesTypes[9459] = PresetUseResultMessage;
         _messagesTypes[294] = PresetUseResultWithMissingIdsMessage;
         _messagesTypes[2517] = ExchangeMoneyMovementInformationMessage;
         _messagesTypes[2936] = ExchangeCraftCountModifiedMessage;
         _messagesTypes[3933] = ExchangeObjectMessage;
         _messagesTypes[8239] = ExchangeObjectAddedMessage;
         _messagesTypes[7967] = ExchangeObjectsAddedMessage;
         _messagesTypes[2518] = ExchangeObjectRemovedMessage;
         _messagesTypes[9984] = ExchangeObjectsRemovedMessage;
         _messagesTypes[4834] = ExchangeObjectModifiedMessage;
         _messagesTypes[899] = ExchangeObjectsModifiedMessage;
         _messagesTypes[390] = ExchangeObjectPutInBagMessage;
         _messagesTypes[9861] = ExchangeObjectRemovedFromBagMessage;
         _messagesTypes[1874] = ExchangeObjectModifiedInBagMessage;
         _messagesTypes[8636] = ExchangeKamaModifiedMessage;
         _messagesTypes[814] = ExchangePodsModifiedMessage;
         _messagesTypes[1359] = ExchangeMultiCraftCrafterCanUseHisRessourcesMessage;
         _messagesTypes[6957] = ExchangeRequestedMessage;
         _messagesTypes[8838] = ExchangeRequestedTradeMessage;
         _messagesTypes[9053] = ExchangeStartedMessage;
         _messagesTypes[5315] = ExchangeStartedWithPodsMessage;
         _messagesTypes[8749] = ExchangeStartedWithStorageMessage;
         _messagesTypes[5558] = ExchangeBidHouseBuyResultMessage;
         _messagesTypes[8921] = ExchangeBidHouseItemAddOkMessage;
         _messagesTypes[3302] = ExchangeBidHouseItemRemoveOkMessage;
         _messagesTypes[5133] = ExchangeBidHouseGenericItemAddedMessage;
         _messagesTypes[5447] = ExchangeBidHouseGenericItemRemovedMessage;
         _messagesTypes[2783] = ExchangeBidHouseInListAddedMessage;
         _messagesTypes[4751] = ExchangeBidHouseInListUpdatedMessage;
         _messagesTypes[898] = ExchangeBidHouseInListRemovedMessage;
         _messagesTypes[8959] = ExchangeBidHouseUnsoldItemsMessage;
         _messagesTypes[1554] = ExchangeOfflineSoldItemsMessage;
         _messagesTypes[8864] = ExchangeIsReadyMessage;
         _messagesTypes[4494] = ExchangeStoppedMessage;
         _messagesTypes[9976] = ExchangeErrorMessage;
         _messagesTypes[7647] = ExchangeLeaveMessage;
         _messagesTypes[8350] = DecraftResultMessage;
         _messagesTypes[8698] = RecycleResultMessage;
         _messagesTypes[3859] = ExchangeStartOkNpcTradeMessage;
         _messagesTypes[9027] = ExchangeStartOkRunesTradeMessage;
         _messagesTypes[5224] = ExchangeStartOkEvolutiveObjectRecycleTradeMessage;
         _messagesTypes[4691] = EvolutiveObjectRecycleResultMessage;
         _messagesTypes[1272] = ExchangeStartOkRecycleTradeMessage;
         _messagesTypes[5255] = ExchangeStartOkNpcShopMessage;
         _messagesTypes[7294] = ExchangeOkMultiCraftMessage;
         _messagesTypes[908] = ExchangeCraftResultMessage;
         _messagesTypes[3459] = ExchangeCraftResultWithObjectIdMessage;
         _messagesTypes[5535] = ExchangeCraftResultWithObjectDescMessage;
         _messagesTypes[4186] = ExchangeCraftResultMagicWithObjectDescMessage;
         _messagesTypes[665] = ExchangeStartOkHumanVendorMessage;
         _messagesTypes[350] = ExchangeShopStockStartedMessage;
         _messagesTypes[8247] = ExchangeShopStockMovementUpdatedMessage;
         _messagesTypes[5634] = ExchangeShopStockMultiMovementUpdatedMessage;
         _messagesTypes[8887] = ExchangeShopStockMovementRemovedMessage;
         _messagesTypes[6186] = ExchangeShopStockMultiMovementRemovedMessage;
         _messagesTypes[9501] = ExchangeStartedMountStockMessage;
         _messagesTypes[7807] = ExchangeStartedTaxCollectorShopMessage;
         _messagesTypes[4057] = ExchangeStartedBidSellerMessage;
         _messagesTypes[4958] = ExchangeStartedBidBuyerMessage;
         _messagesTypes[4482] = ExchangeBidPriceMessage;
         _messagesTypes[7264] = ExchangeBidPriceForSellerMessage;
         _messagesTypes[1423] = ExchangeTypesExchangerDescriptionForUserMessage;
         _messagesTypes[6000] = ExchangeTypesItemsExchangerDescriptionForUserMessage;
         _messagesTypes[6886] = ExchangeWeightMessage;
         _messagesTypes[2529] = ExchangeGuildTaxCollectorGetMessage;
         _messagesTypes[8400] = ItemNoMoreAvailableMessage;
         _messagesTypes[1099] = ExchangeBuyOkMessage;
         _messagesTypes[7279] = ExchangeSellOkMessage;
         _messagesTypes[8775] = ExchangeReplyTaxVendorMessage;
         _messagesTypes[5604] = ExchangeWaitingResultMessage;
         _messagesTypes[4420] = ExchangeStartOkMountWithOutPaddockMessage;
         _messagesTypes[5852] = ExchangeStartOkMountMessage;
         _messagesTypes[9035] = ExchangeMountStableErrorMessage;
         _messagesTypes[2432] = ExchangeMountsStableAddMessage;
         _messagesTypes[4790] = ExchangeMountsPaddockAddMessage;
         _messagesTypes[9611] = ExchangeMountsStableBornAddMessage;
         _messagesTypes[1512] = ExchangeMountsStableRemoveMessage;
         _messagesTypes[1549] = ExchangeMountsPaddockRemoveMessage;
         _messagesTypes[2648] = ExchangeMountsTakenFromPaddockMessage;
         _messagesTypes[7046] = ExchangeMountFreeFromPaddockMessage;
         _messagesTypes[2391] = ExchangeMountSterilizeFromPaddockMessage;
         _messagesTypes[9201] = ExchangeBidSearchOkMessage;
         _messagesTypes[571] = ExchangeItemAutoCraftStopedMessage;
         _messagesTypes[4456] = ExchangeStartOkCraftMessage;
         _messagesTypes[2301] = ExchangeStartOkCraftWithInformationMessage;
         _messagesTypes[6031] = ExchangeStartOkMulticraftCrafterMessage;
         _messagesTypes[9290] = ExchangeStartOkMulticraftCustomerMessage;
         _messagesTypes[241] = ExchangeCrafterJobLevelupMessage;
         _messagesTypes[4353] = ExchangeStartOkJobIndexMessage;
         _messagesTypes[1969] = ExchangeCraftPaymentModifiedMessage;
         _messagesTypes[2256] = UpdateMountCharacteristicsMessage;
         _messagesTypes[8667] = ObjectAveragePricesErrorMessage;
         _messagesTypes[6792] = ObjectAveragePricesMessage;
         _messagesTypes[7335] = PurchasableDialogMessage;
         _messagesTypes[2281] = AccountHouseMessage;
         _messagesTypes[7872] = HousePropertiesMessage;
         _messagesTypes[7480] = HouseBuyResultMessage;
         _messagesTypes[3165] = HouseSellingUpdateMessage;
         _messagesTypes[2920] = HouseToSellListMessage;
         _messagesTypes[8085] = HouseGuildNoneMessage;
         _messagesTypes[5242] = HouseGuildRightsMessage;
         _messagesTypes[1222] = PaddockBuyResultMessage;
         _messagesTypes[1173] = PaddockPropertiesMessage;
         _messagesTypes[4481] = PaddockSellBuyDialogMessage;
         _messagesTypes[7144] = GameDataPlayFarmObjectAnimationMessage;
         _messagesTypes[2097] = PaddockToSellListMessage;
         _messagesTypes[1683] = HavenBagRoomUpdateMessage;
         _messagesTypes[8756] = HavenBagPackListMessage;
         _messagesTypes[8744] = EditHavenBagStartMessage;
         _messagesTypes[2540] = EditHavenBagFinishedMessage;
         _messagesTypes[6985] = HavenBagDailyLoteryMessage;
         _messagesTypes[5258] = HavenBagFurnituresMessage;
         _messagesTypes[8894] = MapComplementaryInformationsDataInHavenBagMessage;
         _messagesTypes[7931] = HavenBagPermissionsUpdateMessage;
         _messagesTypes[3874] = InviteInHavenBagClosedMessage;
         _messagesTypes[6969] = InviteInHavenBagMessage;
         _messagesTypes[1731] = InviteInHavenBagOfferMessage;
         _messagesTypes[8630] = MountSterilizedMessage;
         _messagesTypes[8118] = MountReleasedMessage;
         _messagesTypes[197] = MountRenamedMessage;
         _messagesTypes[4059] = MountXpRatioMessage;
         _messagesTypes[7591] = MountDataMessage;
         _messagesTypes[4449] = MountDataErrorMessage;
         _messagesTypes[7501] = MountSetMessage;
         _messagesTypes[3552] = MountUnSetMessage;
         _messagesTypes[1488] = MountEquipedErrorMessage;
         _messagesTypes[8975] = MountRidingMessage;
         _messagesTypes[3645] = GameDataPaddockObjectRemoveMessage;
         _messagesTypes[2589] = GameDataPaddockObjectAddMessage;
         _messagesTypes[496] = GameDataPaddockObjectListAddMessage;
         _messagesTypes[5738] = MountEmoteIconUsedOkMessage;
         _messagesTypes[5688] = LockableShowCodeDialogMessage;
         _messagesTypes[6030] = LockableCodeResultMessage;
         _messagesTypes[5643] = LockableStateUpdateAbstractMessage;
         _messagesTypes[915] = LockableStateUpdateHouseDoorMessage;
         _messagesTypes[9646] = LockableStateUpdateStorageMessage;
         _messagesTypes[7475] = DocumentReadingBeginMessage;
         _messagesTypes[928] = TitlesAndOrnamentsListMessage;
         _messagesTypes[7417] = TitleGainedMessage;
         _messagesTypes[853] = TitleLostMessage;
         _messagesTypes[1986] = OrnamentGainedMessage;
         _messagesTypes[7044] = OrnamentLostMessage;
         _messagesTypes[3567] = TitleSelectedMessage;
         _messagesTypes[1215] = TitleSelectErrorMessage;
         _messagesTypes[3616] = OrnamentSelectedMessage;
         _messagesTypes[236] = OrnamentSelectErrorMessage;
         _messagesTypes[4599] = ContactLookMessage;
         _messagesTypes[3569] = ContactLookErrorMessage;
         _messagesTypes[9413] = SocialNoticeMessage;
         _messagesTypes[1259] = BulletinMessage;
         _messagesTypes[1339] = SocialNoticeSetErrorMessage;
         _messagesTypes[1428] = AccessoryPreviewErrorMessage;
         _messagesTypes[9725] = AccessoryPreviewMessage;
         _messagesTypes[1794] = HaapiBufferListMessage;
         _messagesTypes[184] = HaapiConfirmationMessage;
         _messagesTypes[5175] = HaapiValidationMessage;
         _messagesTypes[5662] = HaapiBuyValidationMessage;
         _messagesTypes[9615] = HaapiApiKeyMessage;
         _messagesTypes[2356] = HaapiShopApiKeyMessage;
         _messagesTypes[5286] = FinishMoveListMessage;
         _messagesTypes[3293] = TreasureHuntShowLegendaryUIMessage;
         _messagesTypes[8383] = TreasureHuntRequestAnswerMessage;
         _messagesTypes[3778] = TreasureHuntMessage;
         _messagesTypes[8823] = TreasureHuntFinishedMessage;
         _messagesTypes[3587] = TreasureHuntDigRequestAnswerMessage;
         _messagesTypes[9478] = TreasureHuntDigRequestAnswerFailedMessage;
         _messagesTypes[1796] = TreasureHuntFlagRequestAnswerMessage;
         _messagesTypes[2962] = TreasureHuntAvailableRetryCountUpdateMessage;
         _messagesTypes[4020] = BreachStateMessage;
         _messagesTypes[9618] = BreachCharactersMessage;
         _messagesTypes[1197] = BreachBonusMessage;
         _messagesTypes[1748] = BreachBudgetMessage;
         _messagesTypes[745] = BreachSavedMessage;
         _messagesTypes[1846] = BreachBranchesMessage;
         _messagesTypes[7161] = BreachRewardsMessage;
         _messagesTypes[7086] = BreachRewardBoughtMessage;
         _messagesTypes[6134] = BreachInvitationOfferMessage;
         _messagesTypes[9040] = BreachInvitationResponseMessage;
         _messagesTypes[8320] = BreachInvitationCloseMessage;
         _messagesTypes[1022] = BreachKickResponseMessage;
         _messagesTypes[1533] = AnomalySubareaInformationResponseMessage;
         _messagesTypes[8318] = AlignmentWarEffortProgressionMessage;
         _messagesTypes[6450] = CharacterAlignmentWarEffortProgressionMessage;
         _messagesTypes[3836] = AlignmentWarEffortDonatePreviewMessage;
         _messagesTypes[6266] = AlignmentWarEffortDonationResultMessage;
         _messagesTypes[3221] = HaapiTokenMessage;
         _messagesTypes[1713] = HaapiAuthErrorMessage;
         _messagesTypes[3824] = HaapiSessionMessage;
         _messagesTypes[4837] = DebtsUpdateMessage;
         _messagesTypes[6311] = DebtsDeleteMessage;
         _messagesTypes[7004] = ActivitySuggestionsMessage;
         _unpackModes[7526] = UnpackMode.ASYNC;
      }
      ...
      public static function register() : void
      {
         ...
         StoreDataManager.getInstance().registerClass(new ViewQuestListMessage(),true,true);
